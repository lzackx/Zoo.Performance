//
//  ZooTimeProfilerCore.c
//  Zoo
//
//  Created by lZackx on 2022/4/14.

#include "ZooTimeProfilerCore.h"
...
//    });
    pthread_key_create(&_thread_key, &release_thread_call_stack);
    zoo_rebind_symbols((struct zoo_rebinding[1]){"objc_msgSend", (void *)hook_objc_msgSend, (void **)&orig_objc_msgSend},1);
}

void dtp_hook_end(void) {
    _call_record_enabled = false;
    zoo_rebind_symbols((struct zoo_rebinding[1]){"objc_msgSend", (void *)orig_objc_msgSend, NULL},1);
}
