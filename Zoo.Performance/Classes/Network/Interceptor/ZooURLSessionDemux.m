...
@interface ZooURLSessionDemuxTaskInfo : NSObject
...
@interface ZooURLSessionDemuxTaskInfo ()
...
@implementation ZooURLSessionDemuxTaskInfo
...
@interface ZooURLSessionDemux()<NSURLSessionDataDelegate>
...
@implementation ZooURLSessionDemux
...
- (instancetype)initWithConfiguration:(NSURLSessionConfiguration *)configuration{
    ...
    if (self != nil) {
        ...
        [self->_sessionDelegateQueue setName:@"ZooURLSessionDemux"];
        ...
        self->_session.sessionDescription = @"ZooURLSessionDemux";
    }
    return self;
}
...
- (NSURLSessionDataTask *)dataTaskWithRequest:(NSURLRequest *)request delegate:(id<NSURLSessionDataDelegate>)delegate modes:(NSArray *)modes
{
    ...
    ZooURLSessionDemuxTaskInfo *    taskInfo;
    ...
    taskInfo = [[ZooURLSessionDemuxTaskInfo alloc] initWithTask:task delegate:delegate modes:modes];
...
- (ZooURLSessionDemuxTaskInfo *)taskInfoForTask:(NSURLSessionTask *)task{
    ZooURLSessionDemuxTaskInfo *result;
